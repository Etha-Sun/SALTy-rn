    ...
    const struct xnn_qs8_add_minmax_params* params)
{
  ...
  do {
    ...
    vint32m4_t b_i32v = __riscv_vsext_vf4_i32m4(in_b_i8v, vl);

    a_i32v = __riscv_vmul_vx_i32m4(a_i32v, a_multiplier, vl);
    b_i32v = __riscv_vmul_vx_i32m4(b_i32v, b_multiplier, vl);
    vint32m4_t out_i32v = __riscv_vadd_vx_i32m4(a_i32v, bias, vl);
    out_i32v = __riscv_vadd_vv_i32m4(out_i32v, b_i32v, vl);
