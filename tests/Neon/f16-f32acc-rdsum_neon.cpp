  ...
  for (size_t k = 0; k < k3; ++k) {
    for (size_t j = 0; j < k2; ++j) {
      ...
      for (; channels >= 16; channels -= 16) {
        ...
        vst1q_f32(output, v_out0); output = (float*) ((uintptr_t) output + 4 * sizeof(float));
        vst1q_f32(output, v_out1); output = (float*) ((uintptr_t) output + 4 * sizeof(float));
        vst1q_f32(output, v_out2); output = (float*) ((uintptr_t) output + 4 * sizeof(float));
        vst1q_f32(output, v_out3); output = (float*) ((uintptr_t) output + 4 * sizeof(float));
      ...
      if (channels != 0) {
        ...
        for (int i = 0; i < num_full_chunks; ++i) {
          vst1q_f32(output, v_out[i]); output = (float*) ((uintptr_t) output + 4 * sizeof(float));
        }
        ...
        if (channels & 2) {
          vst1_f32(output, vadd_f32(vacc_low, vld1_f32(output))); output = (float*) ((uintptr_t) output + 2 * sizeof(float));
