...
extern "C" {
        ...
        const struct xnn_f16_default_params* params) XNN_OOB_READS
    {
      ...
      // Real float16x8_t is 16 bytes (8 * 2), but our symbolic version is larger
      constexpr size_t kFloat16x8Size = 16;
      ...
      for (; n >= 2 * kFloat16x8Size; n -= 2 * kFloat16x8Size) {
      ...
      for (; n >= 1 * kFloat16x8Size; n -= 1 * kFloat16x8Size) {
