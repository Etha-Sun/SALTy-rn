...
inline float16x8_t vld1q_f16(float16_t const * ptr) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
...
inline uint64x1_t vld1_dup_u64(uint64_t const * ptr) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
    Term _v=_b.loadScalar(_o,64);
    std::array<Term,1> _a; _a.fill(_v);
    return uint64x1_t(tm,_a);
}
...
inline void vst1_u32(uint32_t * ptr, const uint32x2_t& val) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
    _b.storeNeon<32,2>(_o, val);
...
inline void vst1q_f16(float16_t * ptr, const float16x8_t& val) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
...
inline void vst1_lane_s32(int32_t * ptr, const int32x2_t& val, const int lane) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
...
inline void vst1_lane_u64(uint64_t * ptr, const uint64x1_t& val, const int lane) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
    _b.storeScalar(_o, val.getLane(lane), 64);
...
inline void vst1_lane_f16(float16_t * ptr, const float16x4_t& val, const int lane) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
    _b.storeScalar(_o, val.getLane(lane), 16);
...
inline void vst1q_lane_f32(float32_t * ptr, const float32x4_t& val, const int lane) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
    _b.storeScalar(_o, val.getLane(lane), 32);
...
inline int8x8_t vld1_dup_s8(int8_t const * ptr) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
    Term _v=_b.loadScalar(_o,8);
    std::array<Term,8> _a; _a.fill(_v);
    return int8x8_t(tm,_a);
}
...
inline uint8x8_t vld1_dup_u8(uint8_t const * ptr) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
    Term _v=_b.loadScalar(_o,8);
    std::array<Term,8> _a; _a.fill(_v);
    return uint8x8_t(tm,_a);
}
...
inline float16x4_t vld1_dup_f16(float16_t const * ptr) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
    Term _v=_b.loadScalar(_o,16);
    std::array<Term,4> _a; _a.fill(_v);
    return float16x4_t(tm,_a);
}
inline float16x8_t vld1q_dup_f16(float16_t const * ptr) {
    auto& tm = g_ctx->tm;
    auto& _b = g_ctx->findBuffer(ptr);
    size_t _o = _b.ptrToByteOffset(ptr);
    Term _v=_b.loadScalar(_o,16);
    std::array<Term,8> _a; _a.fill(_v);
    return float16x8_t(tm,_a);
}
