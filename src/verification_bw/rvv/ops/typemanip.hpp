#pragma once
// RVV type-manipulation (reinterpret/lmul/get/set/create) — bitwuzla.
...
inline RVVVector __riscv_vlmul_ext_v_u16mf2_u16m1(const RVVVector& op1){ return RVVVector(g_ctx->tm,16,op1.elements()); }
...
inline RVVVector __riscv_vlmul_ext_v_u32m1_u32m2(const RVVVector& op1){ return RVVVector(g_ctx->tm,32,op1.elements()); }
...
inline RVVVector __riscv_vlmul_trunc_v_u16m1_u16mf2(const RVVVector& op1){ return RVVVector(g_ctx->tm,16,op1.elements()); }
...
inline RVVVector __riscv_vlmul_trunc_v_u32m2_u32m1(const RVVVector& op1){ return RVVVector(g_ctx->tm,32,op1.elements()); }
