#pragma once
// RVV initialize/move family — generated (ns salt).
...
inline RVVVector __riscv_vmv_v_x_u16m4(uint16_t src, size_t vl){ return _gini_bcast((int64_t)src,16,vl); }
inline RVVVector __riscv_vmv_v_x_u16m8(uint16_t src, size_t vl){ return _gini_bcast((int64_t)src,16,vl); }
...
inline RVVVector __riscv_vmv_v_x_u32m8(uint32_t src, size_t vl){ return _gini_bcast((int64_t)src,32,vl); }
...
inline int16_t __riscv_vmv_x_s_i16m1_i16(const RVVVector& src){ (void)src; return 0; }
