#pragma once
// RVV integer compare -> mask — generated (ns salt). Signed/unsigned per op suffix.
...
inline Term _gcmp_lane(TermManager& tm, Term a, Term b, CmpOp op){
  ...
  switch(op){
    case C_EQ:  c=tm.mk_term(Kind::EQUAL,{a,b}); break;
    case C_NE:  return fold_ite(tm,tm.mk_term(Kind::EQUAL,{a,b}),zero,one);
    case C_SLT: c=tm.mk_term(Kind::BV_SLT,{a,b}); break;
    case C_ULT: c=tm.mk_term(Kind::BV_ULT,{a,b}); break;
    case C_SLE: c=tm.mk_term(Kind::BV_SLE,{a,b}); break;
    case C_ULE: c=tm.mk_term(Kind::BV_ULE,{a,b}); break;
    case C_SGT: c=tm.mk_term(Kind::BV_SGT,{a,b}); break;
    case C_UGT: c=tm.mk_term(Kind::BV_UGT,{a,b}); break;
    case C_SGE: c=tm.mk_term(Kind::BV_SGE,{a,b}); break;
    case C_UGE: c=tm.mk_term(Kind::BV_UGE,{a,b}); break;
    default: c=tm.mk_term(Kind::EQUAL,{a,b});
  }
...
inline MaskVector __riscv_vmseq_vx_u16m1_b16(const RVVVector& a, uint16_t b, size_t vl){ return _gcmp_vx(a,(int64_t)b,16,C_EQ,vl); }
...
inline MaskVector __riscv_vmseq_vx_u32m2_b16(const RVVVector& a, uint32_t b, size_t vl){ return _gcmp_vx(a,(int64_t)b,32,C_EQ,vl); }
...
inline MaskVector __riscv_vmslt_vx_i32m8_b4(const RVVVector& a, int32_t b, size_t vl){ return _gcmp_vx(a,(int64_t)b,32,C_SLT,vl); }
...
inline MaskVector __riscv_vmsltu_vx_u16m1_b16(const RVVVector& a, uint16_t b, size_t vl){ return _gcmp_vx(a,(int64_t)b,16,C_ULT,vl); }
...
inline MaskVector __riscv_vmsne_vx_u16m1_b16(const RVVVector& a, uint16_t b, size_t vl){ return _gcmp_vx(a,(int64_t)b,16,C_NE,vl); }
