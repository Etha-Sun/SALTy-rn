...
// Module: SALT.Proof.IterationEquiv
// Imports: public import Init public import SALT.Proof.RoundingEquiv public import SALT.Kernel.Neon public import SALT.Kernel.RVV
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_SALT_SALT_Proof_IterationEquiv(uint8_t builtin) {
lean_object * res;
