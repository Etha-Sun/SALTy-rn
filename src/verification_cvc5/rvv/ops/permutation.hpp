#pragma once
// RVV permutation: vslideup/down, vslide1up/down, vrgather(ei16), vcompress, vmerge (cvc5).
...
inline RVVVector __riscv_vcompress_vm_f16m1(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,16,vl); }
inline RVVVector __riscv_vcompress_vm_f16m2(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,16,vl); }
inline RVVVector __riscv_vcompress_vm_f16m4(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,16,vl); }
inline RVVVector __riscv_vcompress_vm_f16m8(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,16,vl); }
inline RVVVector __riscv_vcompress_vm_f16mf2(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,16,vl); }
inline RVVVector __riscv_vcompress_vm_f16mf4(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,16,vl); }
inline RVVVector __riscv_vcompress_vm_f32m1(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,32,vl); }
inline RVVVector __riscv_vcompress_vm_f32m2(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,32,vl); }
inline RVVVector __riscv_vcompress_vm_f32m4(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,32,vl); }
inline RVVVector __riscv_vcompress_vm_f32m8(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,32,vl); }
inline RVVVector __riscv_vcompress_vm_f32mf2(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,32,vl); }
inline RVVVector __riscv_vcompress_vm_f64m1(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,64,vl); }
inline RVVVector __riscv_vcompress_vm_f64m2(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,64,vl); }
inline RVVVector __riscv_vcompress_vm_f64m4(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,64,vl); }
inline RVVVector __riscv_vcompress_vm_f64m8(const RVVVector& src, const MaskVector& mask, size_t vl){ return _gperm_compress(src,mask,64,vl); }
...
inline RVVVector __riscv_vmerge_vvm_f16m2(const RVVVector& op1, const RVVVector& op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vv(op1,op2,mask,16,vl); }
inline RVVVector __riscv_vmerge_vvm_f16mf2(const RVVVector& op1, const RVVVector& op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vv(op1,op2,mask,16,vl); }
inline RVVVector __riscv_vmerge_vvm_f16mf4(const RVVVector& op1, const RVVVector& op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vv(op1,op2,mask,16,vl); }
inline RVVVector __riscv_vmerge_vvm_f32m2(const RVVVector& op1, const RVVVector& op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vv(op1,op2,mask,32,vl); }
inline RVVVector __riscv_vmerge_vvm_f32m4(const RVVVector& op1, const RVVVector& op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vv(op1,op2,mask,32,vl); }
inline RVVVector __riscv_vmerge_vvm_f32mf2(const RVVVector& op1, const RVVVector& op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vv(op1,op2,mask,32,vl); }
inline RVVVector __riscv_vmerge_vvm_f64m1(const RVVVector& op1, const RVVVector& op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vv(op1,op2,mask,64,vl); }
inline RVVVector __riscv_vmerge_vvm_f64m2(const RVVVector& op1, const RVVVector& op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vv(op1,op2,mask,64,vl); }
inline RVVVector __riscv_vmerge_vvm_f64m4(const RVVVector& op1, const RVVVector& op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vv(op1,op2,mask,64,vl); }
inline RVVVector __riscv_vmerge_vvm_f64m8(const RVVVector& op1, const RVVVector& op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vv(op1,op2,mask,64,vl); }
...
inline RVVVector __riscv_vmerge_vxm_i16m2(const RVVVector& op1, int16_t op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vx(op1,mk_bv_val(g_ctx->tm,16,(int64_t)op2),mask,16,vl); }
...
inline RVVVector __riscv_vmerge_vxm_i32m1(const RVVVector& op1, int32_t op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vx(op1,mk_bv_val(g_ctx->tm,32,(int64_t)op2),mask,32,vl); }
...
inline RVVVector __riscv_vmerge_vxm_i32m4(const RVVVector& op1, int32_t op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vx(op1,mk_bv_val(g_ctx->tm,32,(int64_t)op2),mask,32,vl); }
inline RVVVector __riscv_vmerge_vxm_i32m8(const RVVVector& op1, int32_t op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vx(op1,mk_bv_val(g_ctx->tm,32,(int64_t)op2),mask,32,vl); }
...
inline RVVVector __riscv_vmerge_vxm_i8m1(const RVVVector& op1, int8_t op2, const MaskVector& mask, size_t vl){ return _gperm_merge_vx(op1,mk_bv_val(g_ctx->tm,8,(int64_t)op2),mask,8,vl); }
...
inline RVVVector __riscv_vrgather_vv_f16m1(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgather_vv_f16m2(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgather_vv_f16m4(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgather_vv_f16m8(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgather_vv_f16mf2(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgather_vv_f16mf4(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgather_vv_f32m4(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,32,32,vl); }
inline RVVVector __riscv_vrgather_vv_f32m8(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,32,32,vl); }
inline RVVVector __riscv_vrgather_vv_f32mf2(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,32,32,vl); }
inline RVVVector __riscv_vrgather_vv_f64m1(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,64,64,vl); }
inline RVVVector __riscv_vrgather_vv_f64m2(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,64,64,vl); }
inline RVVVector __riscv_vrgather_vv_f64m4(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,64,64,vl); }
inline RVVVector __riscv_vrgather_vv_f64m8(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,64,64,vl); }
inline RVVVector __riscv_vrgather_vv_i16m1(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
...
inline RVVVector __riscv_vrgather_vv_i32m1(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,32,32,vl); }
...
inline RVVVector __riscv_vrgather_vv_i8m1(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,8,8,vl); }
...
inline RVVVector __riscv_vrgather_vv_u32m1(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,32,32,vl); }
...
inline RVVVector __riscv_vrgather_vv_u8m1(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,8,8,vl); }
...
inline RVVVector __riscv_vrgather_vx_f16m1(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,16,vl); }
inline RVVVector __riscv_vrgather_vx_f16m2(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,16,vl); }
inline RVVVector __riscv_vrgather_vx_f16m4(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,16,vl); }
inline RVVVector __riscv_vrgather_vx_f16m8(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,16,vl); }
inline RVVVector __riscv_vrgather_vx_f16mf2(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,16,vl); }
inline RVVVector __riscv_vrgather_vx_f16mf4(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,16,vl); }
inline RVVVector __riscv_vrgather_vx_f32m1(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,32,vl); }
inline RVVVector __riscv_vrgather_vx_f32m2(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,32,vl); }
inline RVVVector __riscv_vrgather_vx_f32m4(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,32,vl); }
inline RVVVector __riscv_vrgather_vx_f32m8(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,32,vl); }
inline RVVVector __riscv_vrgather_vx_f32mf2(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,32,vl); }
inline RVVVector __riscv_vrgather_vx_f64m1(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,64,vl); }
inline RVVVector __riscv_vrgather_vx_f64m2(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,64,vl); }
inline RVVVector __riscv_vrgather_vx_f64m4(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,64,vl); }
inline RVVVector __riscv_vrgather_vx_f64m8(const RVVVector& op1, size_t index, size_t vl){ return _gperm_gather_x(op1,index,64,vl); }
...
inline RVVVector __riscv_vrgatherei16_vv_f16m1(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f16m2(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f16m4(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f16m8(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f16mf2(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f16mf4(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,16,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f32m1(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,32,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f32m2(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,32,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f32m4(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,32,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f32m8(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,32,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f32mf2(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,32,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f64m1(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,64,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f64m2(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,64,vl); }
inline RVVVector __riscv_vrgatherei16_vv_f64m8(const RVVVector& op1, const RVVVector& index, size_t vl){ return _gperm_gather_v(op1,index,16,64,vl); }
...
inline RVVVector __riscv_vslidedown_vx_f16m1(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,16,vl); }
inline RVVVector __riscv_vslidedown_vx_f16m2(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,16,vl); }
inline RVVVector __riscv_vslidedown_vx_f16m4(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,16,vl); }
inline RVVVector __riscv_vslidedown_vx_f16m8(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,16,vl); }
inline RVVVector __riscv_vslidedown_vx_f16mf2(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,16,vl); }
inline RVVVector __riscv_vslidedown_vx_f16mf4(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,16,vl); }
inline RVVVector __riscv_vslidedown_vx_f32m8(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,32,vl); }
inline RVVVector __riscv_vslidedown_vx_f32mf2(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,32,vl); }
inline RVVVector __riscv_vslidedown_vx_f64m1(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,64,vl); }
inline RVVVector __riscv_vslidedown_vx_f64m4(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,64,vl); }
inline RVVVector __riscv_vslidedown_vx_f64m8(const RVVVector& src, size_t offset, size_t vl){ return _gperm_slidedown(src,offset,64,vl); }
...
inline RVVVector __riscv_vslideup_vx_f16m1(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,16,vl); }
inline RVVVector __riscv_vslideup_vx_f16m2(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,16,vl); }
inline RVVVector __riscv_vslideup_vx_f16m4(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,16,vl); }
inline RVVVector __riscv_vslideup_vx_f16m8(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,16,vl); }
inline RVVVector __riscv_vslideup_vx_f16mf2(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,16,vl); }
inline RVVVector __riscv_vslideup_vx_f16mf4(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,16,vl); }
inline RVVVector __riscv_vslideup_vx_f32m2(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,32,vl); }
inline RVVVector __riscv_vslideup_vx_f32m4(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,32,vl); }
inline RVVVector __riscv_vslideup_vx_f32m8(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,32,vl); }
inline RVVVector __riscv_vslideup_vx_f32mf2(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,32,vl); }
inline RVVVector __riscv_vslideup_vx_f64m1(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,64,vl); }
inline RVVVector __riscv_vslideup_vx_f64m2(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,64,vl); }
inline RVVVector __riscv_vslideup_vx_f64m4(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,64,vl); }
inline RVVVector __riscv_vslideup_vx_f64m8(const RVVVector& dest, const RVVVector& src, size_t offset, size_t vl){ return _gperm_slideup(dest,src,offset,64,vl); }
