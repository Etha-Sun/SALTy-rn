...
inline long __riscv_vfirst_m_b1(const MaskVector& op1, size_t vl) { (void)op1; (void)vl; return -1; }

inline long __riscv_vfirst_m_b16(const MaskVector& op1, size_t vl) { (void)op1; (void)vl; return -1; }

inline long __riscv_vfirst_m_b2(const MaskVector& op1, size_t vl) { (void)op1; (void)vl; return -1; }

inline long __riscv_vfirst_m_b32(const MaskVector& op1, size_t vl) { (void)op1; (void)vl; return -1; }

inline long __riscv_vfirst_m_b4(const MaskVector& op1, size_t vl) { (void)op1; (void)vl; return -1; }

inline long __riscv_vfirst_m_b64(const MaskVector& op1, size_t vl) { (void)op1; (void)vl; return -1; }

inline long __riscv_vfirst_m_b8(const MaskVector& op1, size_t vl) { (void)op1; (void)vl; return -1; }
