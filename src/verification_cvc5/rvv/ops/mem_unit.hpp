#pragma once
// RVV unit-stride & mask load/store — generated coverage (cvc5).
#include "../intrinsics.hpp"
namespace salt_cvc5 {
// vbool aliases not declared in intrinsics.hpp (needed by vlm/vsm b1/b64).
using vbool1_t  = MaskVector;
using vbool64_t = MaskVector;
inline RVVVector __riscv_vle16_v_f16m2(const salt_float16* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16_v_f16m2(const xnn_float16* base, size_t vl) {
  return __riscv_vle16_v_f16m2(reinterpret_cast<const salt_float16*>(base), vl);
}
inline RVVVector __riscv_vle16_v_f16m4(const salt_float16* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16_v_f16m4(const xnn_float16* base, size_t vl) {
  return __riscv_vle16_v_f16m4(reinterpret_cast<const salt_float16*>(base), vl);
}
inline RVVVector __riscv_vle16_v_f16mf2(const salt_float16* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16_v_f16mf2(const xnn_float16* base, size_t vl) {
  return __riscv_vle16_v_f16mf2(reinterpret_cast<const salt_float16*>(base), vl);
}
inline RVVVector __riscv_vle16_v_f16mf4(const salt_float16* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16_v_f16mf4(const xnn_float16* base, size_t vl) {
  return __riscv_vle16_v_f16mf4(reinterpret_cast<const salt_float16*>(base), vl);
}
inline RVVVector __riscv_vle16_v_i16m2(const int16_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16_v_i16m4(const int16_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
...
inline RVVVector __riscv_vle16_v_u16m2(const uint16_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
...
inline RVVVector __riscv_vle16ff_v_f16m1(const salt_float16* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16ff_v_f16m1(const xnn_float16* base, size_t* new_vl, size_t vl) {
  return __riscv_vle16ff_v_f16m1(reinterpret_cast<const salt_float16*>(base), new_vl, vl);
}
inline RVVVector __riscv_vle16ff_v_f16m2(const salt_float16* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16ff_v_f16m2(const xnn_float16* base, size_t* new_vl, size_t vl) {
  return __riscv_vle16ff_v_f16m2(reinterpret_cast<const salt_float16*>(base), new_vl, vl);
}
inline RVVVector __riscv_vle16ff_v_f16m4(const salt_float16* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16ff_v_f16m4(const xnn_float16* base, size_t* new_vl, size_t vl) {
  return __riscv_vle16ff_v_f16m4(reinterpret_cast<const salt_float16*>(base), new_vl, vl);
}
inline RVVVector __riscv_vle16ff_v_f16m8(const salt_float16* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16ff_v_f16m8(const xnn_float16* base, size_t* new_vl, size_t vl) {
  return __riscv_vle16ff_v_f16m8(reinterpret_cast<const salt_float16*>(base), new_vl, vl);
}
inline RVVVector __riscv_vle16ff_v_f16mf2(const salt_float16* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16ff_v_f16mf2(const xnn_float16* base, size_t* new_vl, size_t vl) {
  return __riscv_vle16ff_v_f16mf2(reinterpret_cast<const salt_float16*>(base), new_vl, vl);
}
inline RVVVector __riscv_vle16ff_v_f16mf4(const salt_float16* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 16);
}
inline RVVVector __riscv_vle16ff_v_f16mf4(const xnn_float16* base, size_t* new_vl, size_t vl) {
  return __riscv_vle16ff_v_f16mf4(reinterpret_cast<const salt_float16*>(base), new_vl, vl);
}
...
inline RVVVector __riscv_vle32_v_f32mf2(const float* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
inline RVVVector __riscv_vle32_v_i32m2(const int32_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
inline RVVVector __riscv_vle32_v_i32m4(const int32_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
inline RVVVector __riscv_vle32_v_i32m8(const int32_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
...
inline RVVVector __riscv_vle32_v_u32m2(const uint32_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
inline RVVVector __riscv_vle32_v_u32m4(const uint32_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
...
inline RVVVector __riscv_vle32ff_v_f32m1(const float* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
inline RVVVector __riscv_vle32ff_v_f32m2(const float* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
inline RVVVector __riscv_vle32ff_v_f32m4(const float* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
inline RVVVector __riscv_vle32ff_v_f32m8(const float* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
inline RVVVector __riscv_vle32ff_v_f32mf2(const float* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 32);
}
...
inline RVVVector __riscv_vle64_v_f64m1(const double* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 64);
}
inline RVVVector __riscv_vle64_v_f64m2(const double* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 64);
}
inline RVVVector __riscv_vle64_v_f64m4(const double* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 64);
}
inline RVVVector __riscv_vle64_v_f64m8(const double* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 64);
}
...
inline RVVVector __riscv_vle64ff_v_f64m1(const double* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 64);
}
inline RVVVector __riscv_vle64ff_v_f64m2(const double* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 64);
}
inline RVVVector __riscv_vle64ff_v_f64m4(const double* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 64);
}
inline RVVVector __riscv_vle64ff_v_f64m8(const double* base, size_t* new_vl, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  *new_vl = vl;
  return b.loadRVV(b.ptrToByteOffset(base), vl, 64);
}
...
inline RVVVector __riscv_vle8_v_i8m4(const int8_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
...
inline RVVVector __riscv_vle8_v_u8m2(const uint8_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 8);
}
inline RVVVector __riscv_vle8_v_u8m4(const uint8_t* base, size_t vl) {
  auto& b = g_ctx->findBuffer(base);
  return b.loadRVV(b.ptrToByteOffset(base), vl, 8);
}
...
inline vbool1_t __riscv_vlm_v_b1(const uint8_t* base, size_t vl) {
  ...
  for (size_t i = 0; i < vl; i++) {
    ...
    bits.push_back(tm.mkTerm(tm.mkOp(Kind::BITVECTOR_EXTRACT, {lo, lo}), {byte}));
  }
...
inline void __riscv_vse16_v_f16m2(salt_float16* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
...
inline void __riscv_vse16_v_f16m2(xnn_float16* base, const RVVVector& value, size_t vl) {
  __riscv_vse16_v_f16m2(reinterpret_cast<salt_float16*>(base), value, vl);
}
inline void __riscv_vse16_v_f16m4(salt_float16* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse16_v_f16m4(xnn_float16* base, const RVVVector& value, size_t vl) {
  __riscv_vse16_v_f16m4(reinterpret_cast<salt_float16*>(base), value, vl);
}
inline void __riscv_vse16_v_f16mf2(salt_float16* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse16_v_f16mf2(xnn_float16* base, const RVVVector& value, size_t vl) {
  __riscv_vse16_v_f16mf2(reinterpret_cast<salt_float16*>(base), value, vl);
}
inline void __riscv_vse16_v_f16mf4(salt_float16* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse16_v_f16mf4(xnn_float16* base, const RVVVector& value, size_t vl) {
  __riscv_vse16_v_f16mf4(reinterpret_cast<salt_float16*>(base), value, vl);
}
inline void __riscv_vse16_v_i16m1(int16_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse16_v_i16m2(int16_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse16_v_i16m4(int16_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse16_v_u16m2(uint16_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse32_v_f32mf2(float* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse32_v_i32m2(int32_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse32_v_i32m4(int32_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse32_v_i32m8(int32_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse32_v_u32m2(uint32_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse32_v_u32m4(uint32_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse64_v_f64m1(double* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse64_v_f64m2(double* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse64_v_f64m4(double* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse64_v_f64m8(double* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse8_v_u8m2(uint8_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
...
inline void __riscv_vse8_v_u8m4(uint8_t* base, const RVVVector& value, size_t vl) {
  auto& tm = g_ctx->tm;
  auto& b = g_ctx->findBuffer(base);
  std::vector<Term> lanes; lanes.reserve(vl);
  for (size_t i = 0; i < vl; i++) lanes.push_back(value.getElement(i));
