#pragma once
// RVV integer arithmetic / bitwise / shift — generated complete coverage (cvc5).
...
inline Term _gia_lane(TermManager& tm, Term a, Term b, size_t bits, GiaOp op){
  auto K=[&](Kind k,Term x,Term y){return tm.mkTerm(k,{x,y});};
  switch(op){
    case IA_ADD: return K(Kind::BITVECTOR_ADD,a,b);
    case IA_SUB: return K(Kind::BITVECTOR_SUB,a,b);
    case IA_AND: return K(Kind::BITVECTOR_AND,a,b);
    case IA_OR:  return K(Kind::BITVECTOR_OR,a,b);
    case IA_XOR: return K(Kind::BITVECTOR_XOR,a,b);
    case IA_MUL: return K(Kind::BITVECTOR_MULT,a,b);
    case IA_RSUB:return K(Kind::BITVECTOR_SUB,b,a);
    case IA_MINS:return fold_ite(tm,tm.mkTerm(Kind::BITVECTOR_SLE,{a,b}),a,b);
    case IA_MINU:return fold_ite(tm,tm.mkTerm(Kind::BITVECTOR_ULE,{a,b}),a,b);
    case IA_MAXS:return fold_ite(tm,tm.mkTerm(Kind::BITVECTOR_SGE,{a,b}),a,b);
    case IA_MAXU:return fold_ite(tm,tm.mkTerm(Kind::BITVECTOR_UGE,{a,b}),a,b);
    case IA_MULHS:{Term wa=fold_bvsext(tm,bits,a),wb=fold_bvsext(tm,bits,b);
      return fold_bvextract(tm,2*bits-1,bits,tm.mkTerm(Kind::BITVECTOR_MULT,{wa,wb}));}
    ...
    case IA_SDIV:{Term z=mk_bv_val(tm,bits,0),neg1=mk_bv_val(tm,bits,-1);
      return fold_ite(tm,tm.mkTerm(Kind::EQUAL,{b,z}),neg1,tm.mkTerm(Kind::BITVECTOR_SDIV,{a,b}));}
    case IA_UDIV:return K(Kind::BITVECTOR_UDIV,a,b);
    case IA_SREM:return K(Kind::BITVECTOR_SREM,a,b);
    case IA_UREM:return K(Kind::BITVECTOR_UREM,a,b);
    case IA_SLL:{Term sh=tm.mkTerm(Kind::BITVECTOR_AND,{b,mk_bv_val(tm,bits,(int64_t)(bits-1))});
      return tm.mkTerm(Kind::BITVECTOR_SHL,{a,sh});}
    case IA_SRL:{Term sh=tm.mkTerm(Kind::BITVECTOR_AND,{b,mk_bv_val(tm,bits,(int64_t)(bits-1))});
      return tm.mkTerm(Kind::BITVECTOR_LSHR,{a,sh});}
    case IA_SRA:{Term sh=tm.mkTerm(Kind::BITVECTOR_AND,{b,mk_bv_val(tm,bits,(int64_t)(bits-1))});
      return tm.mkTerm(Kind::BITVECTOR_ASHR,{a,sh});}
  }
  return a;
}
enum GiaUn { IAU_NEG,IAU_NOT,IAU_REV8 };
inline Term _gia_un_lane(TermManager& tm, Term a, size_t bits, GiaUn op){
  if(op==IAU_NEG) return tm.mkTerm(Kind::BITVECTOR_NEG,{a});
  if(op==IAU_NOT) return tm.mkTerm(Kind::BITVECTOR_NOT,{a});
  // IAU_REV8: byte-swap within element (little-endian byte reversal)
...
inline RVVVector __riscv_vadd_vv_i16m4(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,16,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vv_i32m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vv_i32m4(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vv_i8m1(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vv_i8m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vv_u16m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,16,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vv_u16m4(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,16,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vv_u32m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vv_u32m4(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vv_u8m1(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vv_u8m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vx_i16m1(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vx_i16m2(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vx_i16m4(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vx_i32m1(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vx_i32m4(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vx_i8m1(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vx_i8m2(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vx_u16m2(const RVVVector& a, uint16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vx_u16m4(const RVVVector& a, uint16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vx_u32m4(const RVVVector& a, uint32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_ADD,vl); }
...
inline RVVVector __riscv_vadd_vx_u8m1(const RVVVector& a, uint8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_ADD,vl); }
inline RVVVector __riscv_vadd_vx_u8m2(const RVVVector& a, uint8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_ADD,vl); }
...
inline RVVVector __riscv_vand_vv_i32m4(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_AND,vl); }
...
inline RVVVector __riscv_vand_vv_i8m1(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_AND,vl); }
inline RVVVector __riscv_vand_vv_i8m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_AND,vl); }
...
inline RVVVector __riscv_vand_vx_i32m1(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_AND,vl); }
inline RVVVector __riscv_vand_vx_i32m2(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_AND,vl); }
inline RVVVector __riscv_vand_vx_i32m4(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_AND,vl); }
...
inline RVVVector __riscv_vand_vx_i8m1(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_AND,vl); }
inline RVVVector __riscv_vand_vx_i8m2(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_AND,vl); }
...
inline RVVVector __riscv_vand_vx_u16m2(const RVVVector& a, uint16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_AND,vl); }
inline RVVVector __riscv_vand_vx_u16m4(const RVVVector& a, uint16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_AND,vl); }
inline RVVVector __riscv_vand_vx_u16m8(const RVVVector& a, uint16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_AND,vl); }
...
inline RVVVector __riscv_vmax_vv_i32m1(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MAXS,vl); }
inline RVVVector __riscv_vmax_vv_i32m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MAXS,vl); }
inline RVVVector __riscv_vmax_vv_i32m4(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MAXS,vl); }
inline RVVVector __riscv_vmax_vv_i32m8(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MAXS,vl); }
...
inline RVVVector __riscv_vmax_vx_i16m2(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_MAXS,vl); }
inline RVVVector __riscv_vmax_vx_i16m4(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_MAXS,vl); }
...
inline RVVVector __riscv_vmax_vx_i32m1(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MAXS,vl); }
inline RVVVector __riscv_vmax_vx_i32m4(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MAXS,vl); }
...
inline RVVVector __riscv_vmaxu_vx_u32m1(const RVVVector& a, uint32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MAXU,vl); }
inline RVVVector __riscv_vmaxu_vx_u32m2(const RVVVector& a, uint32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MAXU,vl); }
inline RVVVector __riscv_vmaxu_vx_u32m4(const RVVVector& a, uint32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MAXU,vl); }
...
inline RVVVector __riscv_vmin_vv_i32m1(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MINS,vl); }
inline RVVVector __riscv_vmin_vv_i32m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MINS,vl); }
inline RVVVector __riscv_vmin_vv_i32m4(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MINS,vl); }
inline RVVVector __riscv_vmin_vv_i32m8(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MINS,vl); }
...
inline RVVVector __riscv_vmin_vx_i16m2(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_MINS,vl); }
inline RVVVector __riscv_vmin_vx_i16m4(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_MINS,vl); }
...
inline RVVVector __riscv_vmin_vx_i32m1(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MINS,vl); }
inline RVVVector __riscv_vmin_vx_i32m4(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MINS,vl); }
...
inline RVVVector __riscv_vminu_vx_u32m1(const RVVVector& a, uint32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MINU,vl); }
inline RVVVector __riscv_vminu_vx_u32m2(const RVVVector& a, uint32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MINU,vl); }
inline RVVVector __riscv_vminu_vx_u32m4(const RVVVector& a, uint32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MINU,vl); }
...
inline RVVVector __riscv_vmul_vv_i32m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MUL,vl); }
inline RVVVector __riscv_vmul_vv_i32m4(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MUL,vl); }
inline RVVVector __riscv_vmul_vv_i32m8(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_MUL,vl); }
...
inline RVVVector __riscv_vmul_vx_i32m1(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MUL,vl); }
inline RVVVector __riscv_vmul_vx_i32m4(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_MUL,vl); }
...
inline RVVVector __riscv_vor_vv_i8m1(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_OR,vl); }
inline RVVVector __riscv_vor_vv_i8m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_OR,vl); }
...
inline RVVVector __riscv_vor_vv_u8m1(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_OR,vl); }
inline RVVVector __riscv_vor_vv_u8m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_OR,vl); }
...
inline RVVVector __riscv_vor_vx_i8m1(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_OR,vl); }
inline RVVVector __riscv_vor_vx_i8m2(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_OR,vl); }
...
inline RVVVector __riscv_vor_vx_u8m1(const RVVVector& a, uint8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_OR,vl); }
inline RVVVector __riscv_vor_vx_u8m2(const RVVVector& a, uint8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_OR,vl); }
...
inline RVVVector __riscv_vrsub_vx_i16m1(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_RSUB,vl); }
inline RVVVector __riscv_vrsub_vx_i16m2(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_RSUB,vl); }
...
inline RVVVector __riscv_vrsub_vx_i32m1(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_RSUB,vl); }
inline RVVVector __riscv_vrsub_vx_i32m2(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_RSUB,vl); }
inline RVVVector __riscv_vrsub_vx_i32m4(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_RSUB,vl); }
...
inline RVVVector __riscv_vrsub_vx_i8m1(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_RSUB,vl); }
inline RVVVector __riscv_vrsub_vx_i8m2(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_RSUB,vl); }
...
inline RVVVector __riscv_vsll_vx_i16m1(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SLL,vl); }
inline RVVVector __riscv_vsll_vx_i16m2(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SLL,vl); }
...
inline RVVVector __riscv_vsll_vx_i32m1(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_SLL,vl); }
inline RVVVector __riscv_vsll_vx_i32m4(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_SLL,vl); }
...
inline RVVVector __riscv_vsll_vx_i8m1(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_SLL,vl); }
inline RVVVector __riscv_vsll_vx_i8m2(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_SLL,vl); }
...
inline RVVVector __riscv_vsll_vx_u16m2(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SLL,vl); }
inline RVVVector __riscv_vsll_vx_u16m4(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SLL,vl); }
...
inline RVVVector __riscv_vsll_vx_u32m4(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_SLL,vl); }
...
inline RVVVector __riscv_vsll_vx_u8m2(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_SLL,vl); }
...
inline RVVVector __riscv_vsrl_vx_u16m1(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SRL,vl); }
inline RVVVector __riscv_vsrl_vx_u16m2(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SRL,vl); }
inline RVVVector __riscv_vsrl_vx_u16m4(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SRL,vl); }
...
inline RVVVector __riscv_vsrl_vx_u32m4(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_SRL,vl); }
...
inline RVVVector __riscv_vsrl_vx_u8m1(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_SRL,vl); }
inline RVVVector __riscv_vsrl_vx_u8m2(const RVVVector& a, size_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_SRL,vl); }
...
inline RVVVector __riscv_vsub_vv_i16m4(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,16,IA_SUB,vl); }
...
inline RVVVector __riscv_vsub_vv_i32m1(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vv_i32m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vv_i32m4(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vv_i32m8(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,32,IA_SUB,vl); }
...
inline RVVVector __riscv_vsub_vv_i8m1(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vv_i8m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_SUB,vl); }
...
inline RVVVector __riscv_vsub_vx_i16m1(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vx_i16m2(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vx_i16m8(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vx_i16mf2(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vx_i16mf4(const RVVVector& a, int16_t b, size_t vl){ return _gia_vx(a,(int64_t)b,16,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vx_i32m1(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vx_i32m4(const RVVVector& a, int32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_SUB,vl); }
...
inline RVVVector __riscv_vsub_vx_i8m1(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vx_i8m2(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_SUB,vl); }
...
inline RVVVector __riscv_vsub_vx_u32m4(const RVVVector& a, uint32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_SUB,vl); }
inline RVVVector __riscv_vsub_vx_u32m8(const RVVVector& a, uint32_t b, size_t vl){ return _gia_vx(a,(int64_t)b,32,IA_SUB,vl); }
...
inline RVVVector __riscv_vxor_vv_i8m1(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_XOR,vl); }
inline RVVVector __riscv_vxor_vv_i8m2(const RVVVector& a, const RVVVector& b, size_t vl){ return _gia_vv(a,b,8,IA_XOR,vl); }
...
inline RVVVector __riscv_vxor_vx_i8m1(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_XOR,vl); }
inline RVVVector __riscv_vxor_vx_i8m2(const RVVVector& a, int8_t b, size_t vl){ return _gia_vx(a,(int64_t)b,8,IA_XOR,vl); }
