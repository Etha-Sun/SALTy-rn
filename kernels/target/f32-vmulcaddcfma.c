    ...
    const struct xnn_f32_minmax_params* params) 
{
  ...
  do {
    ...
    while (c > 0) {
      ...
      // Fused multiply-add to match neonfma (vfmaq_f32) rounding
      vacc0 = __riscv_vfmadd_vv_f32m4(vacc0, vscale, vbias, vl);
      vacc1 = __riscv_vfmadd_vv_f32m4(vacc1, vscale, vbias, vl);
