...
#include "f32-vbinary/gen/f32-vmul-scalar-u1.c"
...
int main() {
    ...
    input_a[0] = 0.0f;          input_b[0] = 12.5f;   // 0 * x
    input_a[1] = 1e20f;         input_b[1] = 1e20f;   // overflow to +inf
    input_a[2] = 1e20f;         input_b[2] = -1e20f;  // overflow to -inf
    input_a[3] = 1e-30f;        input_b[3] = 1e-20f;  // underflow to 0

    xnn_f32_vmul_ukernel__scalar_u1(BATCH_BYTES, input_a, input_b, gold, &params);
