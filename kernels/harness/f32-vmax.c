...
#include "f32-vbinary/gen/f32-vmax-scalar-u1.c"
...
int main() {
    ...
    // the GCC scalar gold (b<a?a:b), NEON vmaxq, and RVV vfmax all agree.
    for (size_t i = 0; i < BATCH_SIZE; i++) {
    ...
    xnn_f32_vmax_ukernel__scalar_u1(BATCH_BYTES, input_a, input_b, gold, &params);
